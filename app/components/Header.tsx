      ...
      <div className="flex items-center justify-between h-full px-4 md:px-8 lg:px-12 xl:px-16 max-w-[1920px] mx-auto">
        ...
        <div className="flex gap-4 md:gap-6 lg:gap-6 xl:gap-8 items-center">
          ...
          {isAuthenticated ? (
            <div className="relative" ref={dropdownRef}>
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 top-12 md:top-13 lg:top-14 xl:top-14 bg-white border-2 border-[#e0e0e0] rounded-xl shadow-lg w-56 md:w-60 lg:w-64 py-2 z-50">
                  ...
                  <button onClick={handleLogout} className="w-full px-4 md:px-5 py-3 md:py-3.5 text-left hover:bg-[#f5f5f5] transition-colors">
            ...
            <button onClick={handleLogin} className="bg-[#bbfb4c] px-6 md:px-8 py-2 md:py-2.5 rounded-lg font-semibold text-[#191919] text-base md:text-lg lg:text-lg xl:text-xl hover:bg-[#a8e03c] transition-colors">
              로그인
            </button>
          )}
        </div>
